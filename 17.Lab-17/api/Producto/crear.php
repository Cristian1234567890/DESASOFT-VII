<?php
        ...
        )
    {
        ...
        if($producto->crear()){
            //asignar el codigo de respuesta -201 creado
        ...
        //si no se puede crear el producto, informar al ususario
        else{
    ...
    //informar al usuario que los datos estan incompletos
        ...
        //asignar el codigo de respuesta -400 solicitud incorrecta
        http_response_code(400);

        // informar al usuario
        echo json_encode(array("message"=>"No se puede crear el producto. Los datos estan incompletos."));
