<?php
    class Producto{
        //Conexion a la base de datos y tabla productos
        private $conn;
        ...
        //constructor con $db como conexion a la base de datos
        ...
        function read(){
            ...
            $query= "SELECT c.nombre as categoria_desc, p.id, p.nombre, p.descripcion, p.precio
        ...
        function crear(){
            ...
            $query = "INSERT INTO 
                        ".$this->nombre_tabla."
                         ...
                         SET 
                         nombre=:nombre, precio=:precio, descripcion =:descripcion, categoria_id=:categoria_id,
                         creado=:creado";
            //preparar el query
            $stmt = $this->conn->prepare($query);
        ...
        function readOne(){
            ...
            $query = "SELECT 
                     ...
                     LIMIT
                         0,1";
            //preparar declaracion de consulta
            $stmt = $this->conn->prepare($query);
