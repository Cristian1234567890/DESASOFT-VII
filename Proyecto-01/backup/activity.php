    ...
    ?>
        ...
        <?php
            ...
            if($_SERVER['REQUEST_METHOD']==='GET'){
                ...
                $nfilas= count($cal);
                print("Se ejecuta ACCION DE GET");
                if($nfilas>0){
                    foreach ($cal as $res){
                        print("<TR>\n");
                        ...
                        print("<TD><FORM NAME='form_mod_activity' METHOD='POST' ACTION='mod-activity.php'><INPUT NAME='mod' VALUE='Modificar' TYPE='submit'><INPUT NAME='val' VALUE=".$res['id']." TYPE='HIDDEN'></FORM></TD>\n");
                        print("<TD><FORM NAME='form_del_activity' METHOD='POST' ACTION='activity.php'><INPUT NAME='del' VALUE='Eliminar' TYPE='submit'><INPUT NAME='val' VALUE=".$res['id']." TYPE='HIDDEN'>\n");
                        print("</TR>\n");
                    }
                    print("</TABLE>\n");
                }
